...
- Please install Arduino-Pico = **Raspberry Pi Pico/RP2040/RP2350** (by Earle F. Philhower, III) core
    ...
    - This sketch is tested with version **5.5.1**: <https://github.com/earlephilhower/arduino-pico/releases/tag/5.5.1>
...
#define PRA32_U2_I2S_SWAP_LEFT_AND_RIGHT       (false)
```
- The following is setting is for [Waveshare Pico-Audio](https://www.waveshare.com/wiki/Pico-Audio) Rev2.1 Version (WAVESHARE-20167) (CURRENTLY NOT RECOMMENDED: No sound unless using Arduino-Pico 4.4.0)
```
//#define PRA32_U2_I2S_DAC_MUTE_OFF_PIN          (0)
