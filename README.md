...
- Features
    - Basic Channel + 0 (Default 1): Main Synth, Poly or Mono; The default program is #4; The FX parameters apply to all channels
    - Basic Channel + 1 (Default 2): Sub Synth 1, Mono; The default program is #5; The FX parameters are disabled
    - Basic Channel + 2 (Default 3): Sub Synth 2, Mono; The default program is #6; The FX parameters are disabled
    - Basic Channel + 3 (Default 4): Sub Synth 3, Mono; The default program is #7; The FX parameters are disabled
