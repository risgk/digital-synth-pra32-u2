...
- Please install Arduino-Pico = **Raspberry Pi Pico/RP2040/RP2350** (by Earle F. Philhower, III) core
    ...
    - This sketch is tested with version **5.2.1**: <https://github.com/earlephilhower/arduino-pico/releases/tag/5.2.1>
...
**Digital Synth PRA32-U2 v1.3.3 by ISGK Instruments (Ryo Ishigaki)**

To the extent possible under law, ISGK Instruments (Ryo Ishigaki)
has waived all copyright and related or neighboring rights
to Digital Synth PRA32-U2 v1.3.3.
