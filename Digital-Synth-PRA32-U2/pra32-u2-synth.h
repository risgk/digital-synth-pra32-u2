...
public:
  ...
  /* INLINE */ void __not_in_flash_func(control_change)(uint8_t control_number, uint8_t controller_value) {
    ...
    case OSC_2_WAVE     :
      ...
      break;
    case OSC_1_SHAPE    :
      m_osc.set_osc1_shape_control<0>(controller_value);
      m_osc.set_osc1_shape_control<1>(controller_value);
      m_osc.set_osc1_shape_control<2>(controller_value);
      m_osc.set_osc1_shape_control<3>(controller_value);
      break;
    case OSC_1_MORPH    :
      m_osc.set_osc1_morph_control<0>(controller_value);
      m_osc.set_osc1_morph_control<1>(controller_value);
      m_osc.set_osc1_morph_control<2>(controller_value);
