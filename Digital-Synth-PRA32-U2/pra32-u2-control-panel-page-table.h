...
static const PRA32_U2_ControlPanelPage g_control_panel_page_table_a[] = {
  ...
  { "Page=A-16 ", "EG e      ",   "EG        ", "Filter Amt", FILTER_EG_AMT  ,   "EG        ", "Velo Sens ", EG_VEL_SENS    ,   "Panel     ", "Play Pitch", PANEL_PLAY_PIT , },
  ...
  { "Page=A-20 ", "Amp c     ",   "Amp       ", "Gain      ", AMP_GAIN       ,   "Amp       ", "Velo Sens ", AMP_VEL_SENS   ,   "Panel     ", "Play Pitch", PANEL_PLAY_PIT , },
