...
static const PRA32_U2_ControlPanelPage g_control_panel_page_table_a[] = {
  ...
  { "Page=A-07 ", "Osc e     ",   "Osc       ", "Drift     ", OSC_DRIFT      ,   "Osc       ", "Saw W Mode", OSC_SAW_W_MODE ,   "Panel     ", "Play Pitch", PANEL_PLAY_PIT , },
  ...
  { "Page=A-16 ", "EG f      ",   "          ", "          ", 0xFF           ,   "Release   ", "Velo Sens ", REL_VEL_SENS   ,   "Panel     ", "Play Pitch", PANEL_PLAY_PIT , },
  { "Page=A-17 ", "Amp a     ",   "Amp       ", "Attack    ", AMP_ATTACK     ,   "Amp       ", "Decay     ", AMP_DECAY      ,   "Panel     ", "Play Pitch", PANEL_PLAY_PIT , },
  { "Page=A-18 ", "Amp b     ",   "Amp       ", "Sustain   ", AMP_SUSTAIN    ,   "Amp       ", "Release   ", AMP_RELEASE    ,   "Panel     ", "Play Pitch", PANEL_PLAY_PIT , },
  { "Page=A-19 ", "Amp c     ",   "Amp       ", "Gain      ", AMP_GAIN       ,   "Amp       ", "Velo Sens ", AMP_VEL_SENS   ,   "Panel     ", "Play Pitch", PANEL_PLAY_PIT , },
  { "Page=A-20 ", "Panner    ",   "Pan       ", "          ", PAN            ,   "          ", "          ", 0xFF           ,   "Panel     ", "Play Pitch", PANEL_PLAY_PIT , },
  { "Page=A-21 ", "LFO a     ",   "LFO       ", "Wave      ", LFO_WAVE       ,   "LFO       ", "Fade Time ", LFO_FADE_TIME  ,   "Panel     ", "Play Pitch", PANEL_PLAY_PIT , },
  { "Page=A-22 ", "LFO b     ",   "LFO       ", "Rate      ", LFO_RATE       ,   "LFO       ", "Depth     ", LFO_DEPTH      ,   "Panel     ", "Play Pitch", PANEL_PLAY_PIT , },
  { "Page=A-23 ", "LFO c     ",   "LFO       ", "Mod Amt   ", LFO_OSC_AMT    ,   "LFO       ", "Mod Dst   ", LFO_OSC_DST    ,   "Panel     ", "Play Pitch", PANEL_PLAY_PIT , },
  { "Page=A-24 ", "LFO d     ",   "LFO       ", "Filter Amt", LFO_FILTER_AMT ,   "          ", "          ", 0xFF           ,   "Panel     ", "Play Pitch", PANEL_PLAY_PIT , },
  { "Page=A-25 ", "Breath    ",   "Breath    ", "Filter Amt", BTH_FILTER_AMT ,   "Breath    ", "Amp Mod   ", BTH_AMP_MOD    ,   "Panel     ", "Play Pitch", PANEL_PLAY_PIT , },
  { "Page=A-26 ", "Aft Touch ",   "Aft Touch ", "LFO Amt   ", AFT_T_LFO_AMT  ,   "          ", "          ", 0xFF           ,   "Panel     ", "Play Pitch", PANEL_PLAY_PIT , },
  { "Page=A-27 ", "Chorus a  ",   "Chorus    ", "Level     ", CHORUS_MIX     ,   "          ", "          ", 0xFF           ,   "Panel     ", "Play Pitch", PANEL_PLAY_PIT , },
  { "Page=A-28 ", "Chorus b  ",   "Chorus    ", "Rate      ", CHORUS_RATE    ,   "Chorus    ", "Depth     ", CHORUS_DEPTH   ,   "Panel     ", "Play Pitch", PANEL_PLAY_PIT , },
  { "Page=A-29 ", "Delay a   ",   "Delay     ", "Level     ", DELAY_LEVEL    ,   "Delay     ", "Mode      ", DELAY_MODE     ,   "Panel     ", "Play Pitch", PANEL_PLAY_PIT , },
  { "Page=A-30 ", "Delay b   ",   "Delay     ", "Time      ", DELAY_TIME     ,   "Delay     ", "Feedback  ", DELAY_FEEDBACK ,   "Panel     ", "Play Pitch", PANEL_PLAY_PIT , },
};
