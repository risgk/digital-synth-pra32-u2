...
const uint8_t g_preset_table_FILTER_RESO    [] = {64 , 64 , 64 , 64 , 64 , 32 , 64 , 0  ,   64 , 64 , 64 , 64 , 64 , 32 , 64 , 0  };
...
const uint8_t g_preset_table_EG_DECAY       [] = {0  , 96 , 96 , 0  , 96 , 96 , 0  , 0  ,   0  , 96 , 96 , 0  , 96 , 96 , 0  , 0  };
...
const uint8_t g_preset_table_EG_AMP_MOD     [] = {0  , 0  , 0  , 0  , 127, 127, 127, 0  ,   0  , 0  , 0  , 0  , 127, 127, 127, 0  };
const uint8_t g_preset_table_REL_EQ_DECAY   [] = {0  , 0  , 0  , 0  , 0  , 0  , 127, 0  ,   0  , 0  , 0  , 0  , 0  , 0  , 127, 0  };
