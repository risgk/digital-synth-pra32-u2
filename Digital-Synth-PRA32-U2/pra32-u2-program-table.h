...
const uint8_t g_preset_table_OSC_1_WAVE     [] = {127, 127, 0  , 25 , 76 , 127, 127, 0  ,   127, 127, 0  , 25 , 76 , 127, 127, 0  };
const uint8_t g_preset_table_MIXER_SUB_OSC  [] = {64 , 127, 64 , 127, 64 , 127, 64 , 64 ,   64 , 127, 64 , 127, 64 , 127, 64 , 64 };
const uint8_t g_preset_table_OSC_1_SHAPE    [] = {0  , 0  , 64 , 64 , 0  , 0  , 0  , 0  ,   0  , 0  , 64 , 64 , 0  , 0  , 0  , 0  };
const uint8_t g_preset_table_OSC_1_MORPH    [] = {64 , 64 , 127, 127, 108, 64 , 64 , 0  ,   64 , 64 , 127, 127, 108, 64 , 64 , 0  };

const uint8_t g_preset_table_OSC_2_WAVE     [] = {0  , 0  , 0  , 25 , 0  , 0  , 0  , 0  ,   0  , 0  , 0  , 25 , 0  , 0  , 0  , 0  };
...
const uint8_t g_preset_table_OSC_2_PITCH    [] = {72 , 109, 72 , 72 , 72 , 72 , 72 , 64 ,   72 , 109, 72 , 72 , 72 , 72 , 72 , 64 };

const uint8_t g_preset_table_FILTER_CUTOFF  [] = {115, 115, 115, 115, 85 , 43 , 127, 127,   115, 115, 115, 115, 85 , 43 , 127, 127};
const uint8_t g_preset_table_FILTER_RESO    [] = {64 , 64 , 64 , 64 , 64 , 64 , 64 , 0  ,   64 , 64 , 64 , 64 , 64 , 64 , 64 , 0  };
const uint8_t g_preset_table_FILTER_EG_AMT  [] = {40 , 64 , 64 , 64 , 64 , 88 , 64 , 64 ,   40 , 64 , 64 , 64 , 64 , 88 , 64 , 64 };
const uint8_t g_preset_table_FILTER_KEY_TRK [] = {64 , 64 , 64 , 64 , 127, 64 , 64 , 64 ,   64 , 64 , 64 , 64 , 127, 64 , 64 , 64 };

const uint8_t g_preset_table_EG_ATTACK      [] = {96 , 32 , 32 , 32 , 32 , 32 , 32 , 0  ,   96 , 32 , 32 , 32 , 32 , 32 , 32 , 0  };
const uint8_t g_preset_table_EG_DECAY       [] = {96 , 32 , 32 , 96 , 96 , 96 , 32 , 0  ,   96 , 32 , 32 , 96 , 96 , 96 , 32 , 0  };
const uint8_t g_preset_table_EG_SUSTAIN     [] = {0  , 127, 127, 0  , 0  , 0  , 127, 127,   0  , 127, 127, 0  , 0  , 0  , 127, 127};
const uint8_t g_preset_table_EG_RELEASE     [] = {32 , 32 , 32 , 32 , 32 , 32 , 32 , 0  ,   32 , 32 , 32 , 32 , 32 , 32 , 32 , 0  };

const uint8_t g_preset_table_EG_OSC_AMT     [] = {64 , 64 , 64 , 72 , 72 , 64 , 64 , 64 ,   64 , 64 , 64 , 72 , 72 , 64 , 64 , 64 };
const uint8_t g_preset_table_EG_OSC_DST     [] = {0  , 0  , 0  , 127, 127, 0  , 0  , 0  ,   0  , 0  , 0  , 127, 127, 0  , 0  , 0  };
const uint8_t g_preset_table_VOICE_MODE     [] = {0  , 127, 0  , 76 , 0  , 76 , 0  , 127,   0  , 127, 0  , 76 , 0  , 76 , 0  , 127};
...
const uint8_t g_preset_table_LFO_OSC_AMT    [] = {64 , 119, 64 , 72 , 64 , 64 , 64 , 64 ,   64 , 119, 64 , 72 , 64 , 64 , 64 , 64 };
const uint8_t g_preset_table_LFO_OSC_DST    [] = {0  , 0  , 0  , 127, 0  , 0  , 0  , 0  ,   0  , 0  , 0  , 127, 0  , 0  , 0  , 0  };
const uint8_t g_preset_table_LFO_FILTER_AMT [] = {76 , 76 , 76 , 64 , 76 , 76 , 64 , 64 ,   76 , 76 , 76 , 64 , 76 , 76 , 64 , 64 };
const uint8_t g_preset_table_AMP_GAIN       [] = {100, 100, 100, 90 , 127, 110, 100, 100,   100, 100, 100, 90 , 127, 110, 100, 100};
...
const uint8_t g_preset_table_EG_AMP_MOD     [] = {0  , 127, 127, 0  , 127, 127, 127, 0  ,   0  , 127, 127, 0  , 127, 127, 127, 0  };
