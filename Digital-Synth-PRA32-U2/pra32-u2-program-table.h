...
const uint8_t g_preset_table_FILTER_CUTOFF  [] = {112, 112, 88 , 127, 88 , 112, 64 , 127,   112, 112, 88 , 127, 88 , 112, 64 , 127};
const uint8_t g_preset_table_FILTER_RESO    [] = {48 , 48 , 48 , 48 , 48 , 48 , 96 , 0  ,   48 , 48 , 48 , 48 , 48 , 48 , 96 , 0  };
