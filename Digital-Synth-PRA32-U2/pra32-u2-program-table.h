...
const uint8_t g_preset_table_OSC_1_WAVE     [] = {127, 127, 127, 0  , 127, 76 , 127, 0  ,   127, 127, 127, 0  , 127, 76 , 127, 0  };
const uint8_t g_preset_table_OSC_1_SHAPE    [] = {0  , 0  , 0  , 64 , 0  , 0  , 0  , 0  ,   0  , 0  , 0  , 64 , 0  , 0  , 0  , 0  };
const uint8_t g_preset_table_OSC_1_MORPH    [] = {64 , 64 , 0  , 127, 64 , 108, 64 , 0  ,   64 , 64 , 0  , 127, 64 , 108, 64 , 0  };
...
const uint8_t g_preset_table_EG_DECAY       [] = {32 , 96 , 32 , 64 , 96 , 100, 32 , 0  ,   32 , 96 , 32 , 64 , 96 , 100, 32 , 0  };
