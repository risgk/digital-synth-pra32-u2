...
const uint8_t g_preset_table_EG_ATTACK      [] = {32 , 96 , 32 , 32 , 32 , 32 , 32 , 32 ,   32 , 96 , 32 , 32 , 32 , 32 , 32 , 32 };
const uint8_t g_preset_table_EG_DECAY       [] = {32 , 96 , 96 , 64 , 96 , 96 , 32 , 32 ,   32 , 96 , 96 , 64 , 96 , 96 , 32 , 32 };
const uint8_t g_preset_table_EG_SUSTAIN     [] = {127, 0  , 0  , 127, 0  , 0  , 127, 127,   127, 0  , 0  , 127, 0  , 0  , 127, 127};
const uint8_t g_preset_table_EG_RELEASE     [] = {32 , 32 , 32 , 32 , 32 , 32 , 32 , 32 ,   32 , 32 , 32 , 32 , 32 , 32 , 32 , 32 };
...
const uint8_t g_preset_table_AMP_RELEASE    [] = {32 , 32 , 32 , 32 , 32 , 32 , 32 , 32 ,   32 , 32 , 32 , 32 , 32 , 32 , 32 , 32 };
...
const uint8_t g_preset_table_EG_AMP_MOD     [] = {127, 0  , 0  , 127, 127, 127, 127, 127,   127, 0  , 0  , 127, 127, 127, 127, 127};
const uint8_t g_preset_table_REL_EQ_DECAY   [] = {127, 127, 127, 127, 127, 127, 127, 127,   127, 127, 127, 127, 127, 127, 127, 127};
