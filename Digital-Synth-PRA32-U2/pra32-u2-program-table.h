...
const uint8_t g_preset_table_OSC_1_WAVE     [] = {127, 127, 25 , 0  , 127, 76 , 0  , 127,   127, 127, 25 , 0  , 127, 76 , 0  , 127};
const uint8_t g_preset_table_MIXER_SUB_OSC  [] = {127, 64 , 127, 64 , 127, 64 , 64 , 64 ,   127, 64 , 127, 64 , 127, 64 , 64 , 64 };
const uint8_t g_preset_table_OSC_1_SHAPE    [] = {0  , 0  , 64 , 64 , 0  , 0  , 0  , 0  ,   0  , 0  , 64 , 64 , 0  , 0  , 0  , 0  };
const uint8_t g_preset_table_OSC_1_MORPH    [] = {64 , 64 , 127, 127, 64 , 108, 0  , 64 ,   64 , 64 , 127, 127, 64 , 108, 0  , 64 };
...
const uint8_t g_preset_table_OSC_2_PITCH    [] = {109, 72 , 72 , 72 , 72 , 72 , 64 , 72 ,   109, 72 , 72 , 72 , 72 , 72 , 64 , 72 };

const uint8_t g_preset_table_FILTER_CUTOFF  [] = {115, 115, 115, 115, 43 , 85 , 127, 127,   115, 115, 115, 115, 43 , 85 , 127, 127};
const uint8_t g_preset_table_FILTER_RESO    [] = {64 , 64 , 64 , 64 , 64 , 64 , 0  , 64 ,   64 , 64 , 64 , 64 , 64 , 64 , 0  , 64 };
...
const uint8_t g_preset_table_EG_ATTACK      [] = {32 , 96 , 32 , 32 , 32 , 32 , 0  , 32 ,   32 , 96 , 32 , 32 , 32 , 32 , 0  , 32 };
const uint8_t g_preset_table_EG_DECAY       [] = {32 , 96 , 96 , 32 , 96 , 96 , 0  , 32 ,   32 , 96 , 96 , 32 , 96 , 96 , 0  , 32 };
const uint8_t g_preset_table_EG_SUSTAIN     [] = {127, 0  , 0  , 127, 0  , 0  , 127, 127,   127, 0  , 0  , 127, 0  , 0  , 127, 127};
const uint8_t g_preset_table_EG_RELEASE     [] = {32 , 32 , 32 , 32 , 32 , 32 , 0  , 32 ,   32 , 32 , 32 , 32 , 32 , 32 , 0  , 32 };
...
const uint8_t g_preset_table_VOICE_MODE     [] = {127, 0  , 76 , 0  , 76 , 0  , 127, 0  ,   127, 0  , 76 , 0  , 76 , 0  , 127, 0  };
...
const uint8_t g_preset_table_LFO_DEPTH      [] = {0  , 0  , 0  , 0  , 0  , 0  , 0  , 127,   0  , 0  , 0  , 0  , 0  , 0  , 0  , 127};

const uint8_t g_preset_table_LFO_OSC_AMT    [] = {119, 64 , 72 , 64 , 64 , 64 , 64 , 64 ,   119, 64 , 72 , 64 , 64 , 64 , 64 , 64 };
const uint8_t g_preset_table_LFO_OSC_DST    [] = {0  , 0  , 127, 0  , 0  , 0  , 0  , 0  ,   0  , 0  , 127, 0  , 0  , 0  , 0  , 0  };
const uint8_t g_preset_table_LFO_FILTER_AMT [] = {76 , 76 , 64 , 76 , 76 , 76 , 64 , 64 ,   76 , 76 , 64 , 76 , 76 , 76 , 64 , 64 };
const uint8_t g_preset_table_AMP_GAIN       [] = {100, 100, 90 , 100, 110, 127, 100, 100,   100, 100, 90 , 100, 110, 127, 100, 100};

const uint8_t g_preset_table_AMP_ATTACK     [] = {32 , 32 , 32 , 32 , 32 , 32 , 0  , 32 ,   32 , 32 , 32 , 32 , 32 , 32 , 0  , 32 };
const uint8_t g_preset_table_AMP_DECAY      [] = {32 , 32 , 32 , 32 , 32 , 32 , 0  , 32 ,   32 , 32 , 32 , 32 , 32 , 32 , 0  , 32 };
const uint8_t g_preset_table_AMP_SUSTAIN    [] = {127, 127, 127, 127, 127, 127, 127, 127,   127, 127, 127, 127, 127, 127, 127, 127};
const uint8_t g_preset_table_AMP_RELEASE    [] = {32 , 32 , 32 , 32 , 32 , 32 , 0  , 32 ,   32 , 32 , 32 , 32 , 32 , 32 , 0  , 32 };
...
const uint8_t g_preset_table_EG_AMP_MOD     [] = {127, 0  , 0  , 127, 127, 127, 0  , 127,   127, 0  , 0  , 127, 127, 127, 0  , 127};
const uint8_t g_preset_table_REL_EQ_DECAY   [] = {127, 127, 127, 127, 127, 127, 0  , 127,   127, 127, 127, 127, 127, 127, 0  , 127};
...
const uint8_t g_preset_table_CHORUS_MIX     [] = {127, 127, 127, 127, 127, 127, 0  , 127,   127, 127, 127, 127, 127, 127, 0  , 127};
...
const uint8_t g_preset_table_DELAY_LEVEL    [] = {64 , 64 , 64 , 64 , 64 , 64 , 0  , 64 ,   64 , 64 , 64 , 64 , 64 , 64 , 0  , 64 };
