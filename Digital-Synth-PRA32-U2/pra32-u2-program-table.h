...
const uint8_t g_preset_table_FILTER_CUTOFF  [] = {112, 112, 88 , 127, 64 , 112, 52 , 127,   112, 112, 88 , 127, 64 , 112, 52 , 127};
const uint8_t g_preset_table_FILTER_RESO    [] = {64 , 64 , 64 , 64 , 64 , 64 , 64 , 0  ,   64 , 64 , 64 , 64 , 64 , 64 , 64 , 0  };
const uint8_t g_preset_table_FILTER_EG_AMT  [] = {40 , 64 , 64 , 64 , 88 , 64 , 88 , 64 ,   40 , 64 , 64 , 64 , 88 , 64 , 88 , 64 };
